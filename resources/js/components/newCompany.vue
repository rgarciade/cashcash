          ...
          <v-card>
            ...
            <v-card-text>
              <v-form
                ...
                <v-text-field v-model="companyData.cif" :rules="cifRules" label="cif de la compañia" ></v-text-field>
                ...
                <v-text-field v-model="companyData.cta" id="c_cta" label="cuenta"></v-text-field>
